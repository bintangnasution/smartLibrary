...
class Admin extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('dashboard__/dashboard__',$data);
        $this->load->view('dashboard__/dashboard');
        $this->load->view('dashboard__/dashboard_');
    }
    ...
    public function notifikasi(){
    	...
    	$this->load->view('dashboard__/dashboard__',$data);
    	$this->load->view('page/notifikasi');
    	$this->load->view('dashboard__/dashboard_');
    }
